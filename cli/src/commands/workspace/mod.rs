...
use self::colocate::WorkspaceColocateArgs;
use self::colocate::cmd_workspace_colocate;
...
pub(crate) enum WorkspaceCommand {
    ...
    Colocate(WorkspaceColocateArgs),
...
pub(crate) async fn cmd_workspace(
    ...
    match subcommand {
        ...
        WorkspaceCommand::Colocate(args) => cmd_workspace_colocate(ui, command, args).await,
